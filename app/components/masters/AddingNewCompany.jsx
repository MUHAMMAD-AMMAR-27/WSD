...
const AddingNewCompany = ({ companyName, companyId, countryId, onDelete, phoneNumber, CountryName}) => {
    ...
    <div className="space-y-3 py-2">
      ...
      shadow-lg duration-200 sm:max-w-lg border-none bg-white"
        ...
        <div>
          ...
          {companyId && countryId && (
            <p className="text-sm p-2 text-left text-gray-800 no-underline">
              <abbr title={CountryName} className="no-underline cursor-default">
                {countryId}
              </abbr>
              {" | "}
              <abbr title={companyName} className="no-underline cursor-default">
                {companyId}
              </abbr>
            </p>
          )}
        ...
        <div className="flex gap-2 items-center md:mt-3">
          <button className="text-blue-500 hover:text-blue-600 p-1 rounded-full hover:bg-blue-50">
            <Pencil />
          </button>
...
export default AddingNewCompany
