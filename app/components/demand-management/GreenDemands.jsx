...
const GreenDemands = ({sn ,demandRefCode, country, countryCode, status, trade, visa, applicantClients }) => {
  return (
    <tbody data-slot="table-body" className="[&amp;_tr:last-child]:border-0">
      ...
      x>
        ...
        <td
          ...
          className="p-2 align-middle whitespace-nowrap [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] false"
        >
          <div className="flex gap-0.5 text-green-600 items-center">
            <button
              data-state="closed"
        ...
        <td
          ...
          className="p-2 align-middle whitespace-nowrap [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] false"
        >
          <span className="truncate text-green-600">{visa}</span>
        </td>
        <td
          data-slot="table-cell"
          className="p-2 align-middle whitespace-nowrap [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] false"
        >
          <span className="truncate text-green-600">{applicantClients}</span>
        </td>
        <td
          data-slot="table-cell"
          className="p-2 align-middle whitespace-nowrap [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px] false"
