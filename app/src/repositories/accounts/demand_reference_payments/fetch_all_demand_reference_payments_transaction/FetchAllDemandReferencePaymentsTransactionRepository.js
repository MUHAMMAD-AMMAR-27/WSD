 ...
 */
export class FetchAllDemandReferencePaymentsTransactionRepository extends BaseRepository {
  /**
  ...
  constructor(payload = {}, retryAttempts = 1) {
    super({ endpoint: "fetch_all_demand_reference_payments_trx.php", payload, retryAttempts });
  }
