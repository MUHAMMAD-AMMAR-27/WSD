 ...
 */
export class FetchAllApplicantPaymentsTransactionRepository extends BaseRepository {
  /**
  ...
  constructor(payload = {}, retryAttempts = 1) {
    super({ endpoint: "fetch_all_applicant_payments_trx.php", payload, retryAttempts });
  }
