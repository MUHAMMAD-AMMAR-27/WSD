 ...
 */
export class CreateApplicantReferencePaymentTransactionRepository extends BaseRepository {
  /**
  ...
  constructor(payload = {}, retryAttempts = 1) {
    super({ endpoint: "create_applicant_ref_payment_trx.php", payload, retryAttempts });
  }
